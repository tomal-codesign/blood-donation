  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50/40 via-white to-white">
      <PageHero
        ...
        description="Immediate blood required? We'll notify nearby donors instantly."
        size="compact"
      >
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {/* Main Content - Form or Login Prompt */}
          <div className="lg:col-span-2">
            {authLoading ? (
              <Card className="border border-gray-100 shadow-xl shadow-red-500/5 rounded-3xl">
                <CardContent className="py-16 flex flex-col items-center justify-center">
                  <div className="relative">
                    ...
                    <div className="relative w-14 h-14 rounded-full bg-gradient-to-br from-red-500 via-rose-500 to-orange-400 flex items-center justify-center shadow-lg shadow-red-500/30">
                      <Droplet className="h-7 w-7 text-white animate-bounce" />
                    </div>
                  </div>
                  <p className="mt-4 text-gray-500 font-medium">Checking your session...</p>
                </CardContent>
              </Card>
            ) : user ? (
              ...
              <Card className="border-2 border-red-200 shadow-xl shadow-red-500/10 rounded-3xl overflow-hidden">
                <div className="bg-gradient-to-r from-red-600 via-rose-600 to-orange-500 p-6 text-center">
                  <div className="inline-flex p-3 bg-white/20 rounded-2xl mb-3 backdrop-blur-sm">
                    <LogIn className="h-8 w-8 text-white" />
                  </div>
                  <h2 className="text-2xl font-bold text-white">Login Required</h2>
                  <p className="text-red-50 mt-1 text-sm max-w-md mx-auto">
                    You need to be logged in to submit an emergency blood request. It only takes a minute.
                  </p>
                </div>
                <CardContent className="p-6">
                  <div className="space-y-3">
                    <Link href="/login" className="block">
                      <Button className="w-full h-12 bg-gradient-to-r from-red-600 to-rose-600 hover:opacity-90 shadow-lg shadow-red-500/25 rounded-xl font-semibold text-base">
                    ...
                    <Link href="/register" className="block">
                      <Button
                        variant="outline"
                        className="w-full h-12 border-2 border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300 rounded-xl font-semibold"
                      >
