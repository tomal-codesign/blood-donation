// app/dashboard/hospital/new-request/page.tsx
'use client';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // ✅ Redirect to Hospital Requests page after successful creation
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-red-50 mt-1.5 text-sm sm:text-base max-w-md">
              Request blood for your hospital. Donors in your area will be notified.
            </p>
          </div>
        ...
        <CardContent className="p-5 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-100">
              <Link href="/dashboard/hospital/requests" className="sm:w-1/3">
