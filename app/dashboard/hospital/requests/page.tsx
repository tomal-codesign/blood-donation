...
export default function HospitalRequestsPage() {
    ...
    const stats = useMemo(() => {
        ...
        return { total: requests.length, pending, matched, fulfilled, cancelled, critical, totalUnits };
    }, [requests]);
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-red-600 via-rose-600 to-orange-500 p-6 sm:p-8 shadow-xl shadow-red-500/20">
                ...
                <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <h1 className="text-2xl sm:text-3xl font-bold text-white">Blood Requests</h1>
                        <p className="text-red-50 mt-1.5 text-sm sm:text-base max-w-md">
                            Track, manage, and monitor your hospital's blood requests in one place
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Link href="/dashboard/hospital/new-request">
                ...
                <Card className="border-2 border-dashed border-gray-200 bg-gradient-to-b from-white to-gray-50/50">
                    <CardContent className="py-16 text-center">
                        ...
                        <p className="text-gray-500 text-sm max-w-sm mx-auto mb-6">
                            {requests.length === 0
                                ? "Your hospital hasn't created any blood requests yet. When you need blood, create a request and donors in your area will be notified."
