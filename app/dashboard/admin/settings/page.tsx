              ...
              <div className="flex items-start gap-4 p-4 bg-red-50 rounded-xl border border-red-100 mb-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-600 mt-1">
                    Deleting your admin account will permanently remove all your data including account details, and personal information.
                  </p>
                </div>
              </div>
              <Button 
            ...
            <div className="space-y-5">
              <div className="p-5 bg-red-50 rounded-xl border border-red-100">
                ...
                <p className="text-sm text-red-700">
                  This will permanently delete your admin account and all associated data. This action cannot be reversed.
                </p>
              </div>
